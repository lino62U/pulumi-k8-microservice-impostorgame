...
const FOOTBALL_PLAYERS = ['Lionel Messi','Cristiano Ronaldo','Neymar Jr','Kylian Mbappé','Robert Lewandowski','Kevin De Bruyne','Luka Modrić','Sergio Ramos','Virgil van Dijk','Sadio Mané','Mohamed Salah','Karim Benzema','Erling Haaland','Zlatan Ibrahimović','Andrés Iniesta','Xavi Hernández','Carles Puyol','Ronaldinho','Ronaldo Nazário','Zinedine Zidane'];
